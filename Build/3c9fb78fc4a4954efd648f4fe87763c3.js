...
var ASM_CONSTS = {
  4192000: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4192055: function($0) {performance.now = function() { return $0; };},  
 4192103: function($0) {performance.now = function() { return $0; };},  
 4192151: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4192206: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4192267: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4192331: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _SendScore(user, coins, score) {
      ...
      if (window && window.Telegram && window.Telegram.WebApp) {
        ...
        try {
          window.Telegram.WebApp.sendData({ user: u, coins: c, score: s });
