...
var ASM_CONSTS = {
  4205136: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4205191: function($0) {performance.now = function() { return $0; };},  
 4205239: function($0) {performance.now = function() { return $0; };},  
 4205287: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4205342: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4205403: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4205467: function() {return Module.webglContextAttributes.powerPreference;}
};
            ...
            window.Telegram.WebApp.showPopup(
              {
                ...
                message:
                  "PC Not Supported Yet! \nPlease use a mobile device to connect OKX wallet.",
              },
              function () {
                window.unityInstance.SendMessage(
                  "GameManager",
