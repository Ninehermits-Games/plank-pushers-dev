...
var ASM_CONSTS = {
  4181808: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4181863: function($0) {performance.now = function() { return $0; };},  
 4181911: function($0) {performance.now = function() { return $0; };},  
 4181959: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4182014: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4182075: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4182139: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  async function _Validate(url) {
      if (window.Telegram.WebApp && window.unityInstance) {
        ...
        try {
          ...
          //   function (err, value) {
          //     if (err) {
          //       window.Telegram.WebApp.CloudStorage.setItem("proofofLife", "0");
          //     } else {
          //       if (data.sbt && value === "0") {
          //         window.Telegram.WebApp.CloudStorage.setItem("proofofLife", "1");
          //       }
          //     }
          //   }
          // );
