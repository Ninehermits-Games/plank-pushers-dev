...
var ASM_CONSTS = {
  4206256: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4206311: function($0) {performance.now = function() { return $0; };},  
 4206359: function($0) {performance.now = function() { return $0; };},  
 4206407: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4206462: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4206523: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4206587: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _ConsumableUsed(consumable) {
      if (
        ...
        window.socket.emit("consumableUsed", data);
        console.log({ data });
      } else {
