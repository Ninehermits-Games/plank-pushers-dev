...
var ASM_CONSTS = {
  4196112: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4196167: function($0) {performance.now = function() { return $0; };},  
 4196215: function($0) {performance.now = function() { return $0; };},  
 4196263: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4196318: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4196379: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4196443: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _SaveWalletData(url, userId) {
      if (
        window &&
        window.Telegram &&
        ...
        (async () => {
          ...
          const response = await fetch(`${l}wallet/${userId}`, {
            body: account,
            method: "POST",
            headers: {
