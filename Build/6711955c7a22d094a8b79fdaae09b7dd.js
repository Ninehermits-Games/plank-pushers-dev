...
var ASM_CONSTS = {
  4056736: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4056791: function($0) {performance.now = function() { return $0; };},  
 4056839: function($0) {performance.now = function() { return $0; };},  
 4056887: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4056942: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4057003: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4057067: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _CreateIframe(url, width, height) {
      var iframeUrl = UTF8ToString(url);
      var iframe = document.createElement("iframe");
      iframe.src = iframeUrl;
      iframe.style.width = UTF8ToString(width);
      iframe.style.height = UTF8ToString(height);
  ...
  function _InitializeIframeOverlay() {
      // Add styles
      const styles = `
              .iframe-overlay {
                  position: fixed;
      ...
      const overlayHTML = `
              <div id="iframeOverlay" class="iframe-overlay">
                  <div class="iframe-container">
                      <button class="close-button" id="closeIframeButton">✕</button>
                      <iframe id="overlayIframe" class="iframe-content"></iframe>
                  </div>
              </div>
          `;
      ...
      document
        .getElementById("closeIframeButton")
...
var asmLibraryArg = {
  ...
  "InitializeIframeOverlay": _InitializeIframeOverlay,
