...
var ASM_CONSTS = {
  4196256: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4196311: function($0) {performance.now = function() { return $0; };},  
 4196359: function($0) {performance.now = function() { return $0; };},  
 4196407: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4196462: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4196523: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4196587: function() {return Module.webglContextAttributes.powerPreference;}
};
        ...
        (async () => {
          ...
          try {
           ...
           if (!response.ok) {
            ...
            //   window.unityInstance.SendMessage("GameManger", "SetPremium", premium);
            // }
          } catch (validateErr) {
