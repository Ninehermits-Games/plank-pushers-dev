...
var ASM_CONSTS = {
  4696608: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4696663: function($0) {performance.now = function() { return $0; };},  
 4696711: function($0) {performance.now = function() { return $0; };},  
 4696759: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4696814: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4696875: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4696939: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _ShareInviteLink(link) {
      var l = Pointer_stringify(link);
  
      console.log("Link received", l);
      (async () => {
        const shareData = {
          text:
            "Join Me in Plank Pushers!\nWant to join the fun and become friends in-game? Connect with me and start playing: " +
            l +
