...
var ASM_CONSTS = {
  4191760: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4191815: function($0) {performance.now = function() { return $0; };},  
 4191863: function($0) {performance.now = function() { return $0; };},  
 4191911: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4191966: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4192027: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4192091: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _GenerateTONInvoice(baseUrl, token, inv_t) {
      if (
        window &&
        window.Telegram &&
        window.Telegram.WebApp &&
  ...
  function _SendScore(coins, score) {
      //string user, string coins, string score
      if (
        window &&
        window.Telegram &&
        window.Telegram.WebApp &&
        ...
        // const u = UTF8ToString(user);
        // const c = UTF8ToString(coins);
        // const s = UTF8ToString(score);
        try {
          // const data = { user: u, coins: c, score: s };
          // window.Telegram.WebApp.CloudStorage.setItem(
          //   "score",
          //   JSON.stringify(data)
          // );
          window.Telegram.WebApp.CloudStorage.setItem("coins", coins);
          window.Telegram.WebApp.CloudStorage.setItem("score", score);
  ...
  function _VerifyTONTransaction(baseUrl, token, payload, boc, time_out) {
      if (
        window &&
        window.Telegram &&
        window.Telegram.WebApp &&
