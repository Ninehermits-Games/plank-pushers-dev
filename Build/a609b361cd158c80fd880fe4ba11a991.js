...
var ASM_CONSTS = {
  4191248: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4191303: function($0) {performance.now = function() { return $0; };},  
 4191351: function($0) {performance.now = function() { return $0; };},  
 4191399: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4191454: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4191515: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4191579: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _GenerateTONInvoice(baseUrl, token, inv_type) {
      if (
        window &&
        window.Telegram &&
        window.Telegram.WebApp &&
        ...
        (async () => {
          try {
            const url = UTF8ToString(baseUrl);
            const tkn = UTF8ToString(token);
            const inv_type = UTF8ToString(inv_type);
            const response = await fetch(url, {
              method: "GET",
              headers: {
                "Content-Type": "application/json",
  ...
  function _SendScore(user, coins, score) {
