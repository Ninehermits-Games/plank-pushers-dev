...
var ASM_CONSTS = {
  4196432: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4196487: function($0) {performance.now = function() { return $0; };},  
 4196535: function($0) {performance.now = function() { return $0; };},  
 4196583: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4196638: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4196699: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4196763: function() {return Module.webglContextAttributes.powerPreference;}
};
           ...
           if (!response.ok) {
            ...
            if(typeof invoiceLink !== "undefined" && invoiceLink !== null && window.unityInstance) {
             ...
             if(typeof status !== "undefined" && status !== null && status === "premium" && window.unityInstance) {
              window.Telegram.WebApp.showAlert("Your premium subscription has been activated!", () => window.unityInstance.SendMessage("RequestHandler", "SetPremiumButtonVal", "false"));
            }
          } catch (err) {
            console.log({ err });
          }
  ...
  function _Screenshot(base64String) {
      ...
      var base64 = UTF8ToString(base64String);
      ...
      (async () => {
        ...
        const shareData = {
          text: "Check Out My High Score!\nI just played Plank Pushers! Think you can beat me? Join the community now and give it a try: https://t.me/+Z43kTqZEVMg0N2U0. Let's see who can get the highest score!",
