...
var ASM_CONSTS = {
  4182304: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4182359: function($0) {performance.now = function() { return $0; };},  
 4182407: function($0) {performance.now = function() { return $0; };},  
 4182455: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4182510: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4182571: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4182635: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _OKXWalletConnected() {
      if (
        ...
        return window.OKX_TON.connected;
      } else {
        return false;
      }
    }
