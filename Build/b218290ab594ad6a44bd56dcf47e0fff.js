...
var ASM_CONSTS = {
  4196144: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4196199: function($0) {performance.now = function() { return $0; };},  
 4196247: function($0) {performance.now = function() { return $0; };},  
 4196295: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4196350: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4196411: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4196475: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _SaveWalletData(url, token) {
      if (
        ...
        window.tonConnectUI && window.tonConnectUI.connected
      ) {
        (async () => {
          const l = UTF8ToString(url);
