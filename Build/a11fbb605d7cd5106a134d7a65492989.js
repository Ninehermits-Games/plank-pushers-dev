...
var ASM_CONSTS = {
  3267168: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3267223: function($0) {performance.now = function() { return $0; };},  
 3267271: function($0) {performance.now = function() { return $0; };},  
 3267319: function() {performance.now = Module['emscripten_get_now_backup'];},  
 3267374: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3267435: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3267499: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _WalletConnect(returnUrl, manifest) {
      if (
        window &&
        window.Telegram &&
