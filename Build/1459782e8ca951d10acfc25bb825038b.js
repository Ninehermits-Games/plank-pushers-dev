...
var ASM_CONSTS = {
  4197088: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4197143: function($0) {performance.now = function() { return $0; };},  
 4197191: function($0) {performance.now = function() { return $0; };},  
 4197239: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4197294: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4197355: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4197419: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _Screenshot(base64String) {
      ...
      try {
        ...
        const shareData = {
          ...
          text: "Here's a cool image I wanted to share with you.",
        };
